...
text(" 00   00", width*0.02, height*0.25);
text("00  0  0", width*0.02, height*0.35);
text("0  000  ", width*0.02, height*0.45);
text("  00 00 ", width*0.02, height*0.55);
text(" 00   00", width*0.02, height*0.65);
text("  00 00 ", width*0.02, height*0.75);
text("0  000  ", width*0.02, height*0.85);
text("00  0  0", width*0.02, height*0.95);
